...
![workflow](diagrams/svgWorkflow.svg){fig-align="center" width="676" height="190"}
...
::: code-fold-flex
```{sql}
#| label: dropForecastView
#| code-summary: Drop transformation view.
#| connection: duckdb_con
...
::: code-fold-flex
```{sql}
#| label: cleanForecastData
#| code-summary: Db cleanup
#| connection: duckdb_con
...
```{r}
#| label: "baseCosts"
#| code-summary: "Create base_costs db table."
#| 
...
```{r}
#| label: "costCalculation"
#| code-summary: "In database calculations return hypothetical costs associated with a certain scenarios based on weather code data."
...
opt_css(
css = '
#costBreak .gt_table_body td.gt_row {
box-shadow: -1px -1px 7px 1px rgba(0, 0, 0, 0.2) inset;
} 
'
)
...
```{r}
#| label: "scenarioExplanations"
#| code-summary: "Create the scenario explanations tibble."
...
::: column-page-right
```{r}
#| label: "tbl-scenarioExplanations"
#| echo: false
rTable |>
opt_css(
css = '
#scenarioExp .gt_table_body td.gt_row {
box-shadow: -1px -1px 7px 1px rgba(0, 0, 0, 0.2) inset;
} 
'
)
...
::: {.p-3 style="font-size: 95%; text-align: center"}
$$
...
#| code-summary: Contextualize weather data by linking codes to insights using in-database processing.
#| connection: duckdb_con
...
::: {.p-1 style="font-size: 90%; text-align: left"}
...
:::: column-page-right
::: {.p-1 style="font-size: 100%; text-align: center"}
...
::: code-fold-flex
```{r}
#| label: "executeAggFunctions"
#| code-summary: "Testing sql aggregate functions."
# Define parameters
...
```{r}
#| label: "tempWC"
#| code-summary: "Historical relationship between temperature and weather code data."
...
ggplot(temp_weather_code, aes(x = as.factor(weather_code), y = temperature_2m)) +
     geom_boxplot() +
     labs(title = "Temperature by Weather Code", x = "Weather Code", y = "Temperature") +
     ggplot_theming(
